...
export const debug = {
  startDebugging: async (_folder: WorkspaceFolder | undefined, _config: DebugConfiguration) => true
};
...
export function createMockDocument(content: string, fileName: string = '/test/sample.test.ts'): TextDocument {
...
export function createMockConfig(values: Record<string, unknown> = {}): WorkspaceConfiguration {
  return {
